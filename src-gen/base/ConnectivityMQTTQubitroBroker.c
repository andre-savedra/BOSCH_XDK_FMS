 ...
 */
static const char* MQTT_CLIENT_ID = "a93bd7ed-74ec-4799-8801-265d6555685b";

static const char* MQTT_BROKER_HOST = "broker.qubitro.com";
...
const char* usernameBuf = "a93bd7ed-74ec-4799-8801-265d6555685b";

StringDescr_T password;
const char* passwordBuf = "oyJ2AjUq$kqU3Fd7Q47y7o87MDj5rAiP0-ZoRJci";
...
/**
 * Provides read access to the qubitroTopik signal.
 */
...
/**
 * Provides write access to the qubitroTopik signal.
 */
Retcode_T ConnectivityMQTTQubitroBroker_QubitroTopik_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static char *topic = "a93bd7ed-74ec-4799-8801-265d6555685b";
